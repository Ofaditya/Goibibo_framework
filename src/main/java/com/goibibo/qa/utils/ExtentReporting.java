...
// here i am extending the TestListrener Adapter class so that i can 
//ovveride the methods in that class and use them according to my purpose
		...
		public void onStart(ITestContext testContext)
			{
				...
				htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "/Reports/" + "GoIBiBo.html");//specifying location of the report
				...
				extent.setSystemInfo("Host name", "localhost"); //doing this i=on my own  local machine 
				extent.setSystemInfo("Environemnt", "QA"); //
				extent.setSystemInfo("user", "Harish");

				htmlReporter.config().setDocumentTitle("GoIbibo Test Project"); // Tile of report
